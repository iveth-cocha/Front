    ...
    <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
        ...
        <ul className="mt-5">
            ...
            <li className="text-center">
                <Link to='/Delegaciones' className={`${urlActual === '/Delegaciones' ? 'text-slate-200 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Delegaciones</Link>
            </li>
