  ...
  return (
    <div className='rounded-md border-2 border-sky-950 p-8 mb-2'>
      ...
      <div className='flex mb-3'>
        ...
        <input type="String" className="block  rounded-md border border-gray-300 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-sky-900 py-1 px-2 text-gray-500" />
      </div>
      <div className='flex mb-3'>
