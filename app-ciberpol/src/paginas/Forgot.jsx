            ...
            <div className="flex flex-col justify-center items-center h-full">
                ...
                <form>
                    <div className='mb-7' >
                        ...
                        <input type="email" className="block w-96 rounded-md border border-gray-300 focus:border-sky-900 focus:outline-none focus:ring-1 focus:ring-sky-900 py-1 px-2 text-gray-500" />
                    </div>
                    <div className="mx-8">
                        <Link to="/" className="py-2 w-full block text-center bg-gray-500 text-slate-300 border rounded-xl hover:scale-100 duration-300 hover:bg-gray-900 hover:text-white">Recupera Contraseña</Link>
                    </div>
                </form>
